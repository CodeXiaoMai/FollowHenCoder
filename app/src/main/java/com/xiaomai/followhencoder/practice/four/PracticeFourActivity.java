...
public class PracticeFourActivity extends BasePracticeActivity {

    {
        ...
        pageModels.add(new PageModel(R.layout.practice_matrix_custom, R.string.title_matrix_custom, R.layout.practice_matrix_custom));
