...
public class Practice05AnimatorSetLayout extends RelativeLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        final View view = findViewById(R.id.objectAnimatorView);
        ...
        btAnimate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 方法一：
//                animationSet.play(animator1).before(animator2);
//                animationSet.playTogether(animator2, animator3);

                // 方法二：
                animationSet.play(animator2).with(animator3).after(animator1);
                animationSet.start();
            }
        });
    }
