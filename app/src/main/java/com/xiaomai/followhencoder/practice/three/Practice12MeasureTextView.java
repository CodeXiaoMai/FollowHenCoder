...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text1, 0, 200, paint1);
        canvas.drawText(text2, 0 + paint1.measureText(text1), 200, paint2);
        canvas.drawText(text3, 0 + paint1.measureText(text1) + paint2.measureText(text2), 200, paint1);
    }
}
